...
/*! Tries to start to record an audio file showing an <UIAlertView> object as the UI control to cancel or finish the recording.
 ...
 @note Deprecated: Please use -[Bit6AudioRecorderController startRecordingAudioForMessage:maxDuration:delegate:errorHandler:] instead
 */
- (void) startRecordingAudioForMessage:(Bit6OutgoingMessage*)msg maxDuration:(NSTimeInterval)maxDuration delegate:(id <Bit6AudioRecorderControllerDelegate>)delegate noMicBlock:(void (^)())noMicBlock __attribute__((deprecated("Please use -[Bit6AudioRecorderController startRecordingAudioForMessage:maxDuration:delegate:errorHandler:] instead")));
