...
class AppDelegate: UIResponder, UIApplicationDelegate, Bit6IncomingCallHandlerDelegate {
    ...
    */
    ...
    func incomingCallNotificationBannerContentView() -> UIView
    {
        ...
        button2.setTitle("Answer", forState: .Normal)
    ...
    */
    ...
    func receivedIncomingCallNotification(notification:NSNotification) {
        ...
        if self.callController != nil {
            ...
            //get the call type
            var type = callController.hasVideo ?"Video": callController.hasAudio ?"Audio":"Data"
    ...
    func answerCall(callController:Bit6CallController) {
        ...
        //create a custom in-call UIViewController
        //var callVC = MyCallViewController()
